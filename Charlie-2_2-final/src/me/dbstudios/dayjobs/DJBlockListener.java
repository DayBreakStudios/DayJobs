...
public class DJBlockListener extends BlockListener {
	...
	public void onBlockPlace(BlockPlaceEvent ev) {
		...
		common.ifDebug("Caught BlockPlaceEvent for " + player + ".");
		...
		if (!common.checkMatch(block, player, "can-place") && !common.isExempt(player)) {
			...
			common.ifDebug("    Cancelled BlockPlaceEvent for " + player + ".");
		}
	}
	...
	public void onBlockBreak(BlockBreakEvent ev) {
		...
		common.ifDebug("Caught BlockBreakEvent for " + player + ".");
		...
		if (!common.checkMatch(block, player, "can-break") && !common.isExempt(player)) {
			...
			common.ifDebug("    Cancelled BlockBreakEvent for " + player + ".");
		}
	}
}
